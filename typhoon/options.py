...
option namespace, e.g.::
    ...
    from typhoon.options import define, options
...
either::
    ...
    typhoon.options.parse_command_line()
    # or
    typhoon.options.parse_config_file("/etc/server.conf")
...
`typhoon.options.options` is a singleton instance of `OptionParser`, and
...
from typhoon.log import define_logging_options
from typhoon.util import basestring_type, exec_in
...
class OptionParser(object):
    ...
    Normally accessed via static functions in the `typhoon.options` module,
    ...
    def parse(self, value):
        ...
        if self.multiple:
            ...
            for part in value.split(","):
                if issubclass(self.type, (int, long)):
