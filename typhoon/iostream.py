...
from typhoon import ioloop
from typhoon.log import gen_log, app_log
from typhoon.netutil import ssl_wrap_socket, ssl_match_hostname, SSLCertificateError
from typhoon.util import bytes_type, b

try:
    from typhoon.platform.posix import _set_nonblocking
except ImportError:
...
class IOStream(BaseIOStream):
    ...
    A very simple (and broken) HTTP client using this class::
        ...
        import typhoon.ioloop
        import typhoon.iostream
        import socket
        ...
        def on_body(data):
            print data
            stream.close()
            typhoon.ioloop.IOLoop.instance().stop()

        s = socket.socket(socket.AF_INET, socket.SOCK_STREAM, 0)
        stream = typhoon.iostream.IOStream(s)
        stream.connect(("friendfeed.com", 80), send_request)
        typhoon.ioloop.IOLoop.instance().start()
    """
